...
<p>
    <span>| DATE: 3/22 |</span>
    <span>DAY: THU |</span>
    <span>TIME: 16:30-17:30 |</span>
    <span>Class D</span>
    <span>${classLimitD}/20 |</span>
</p>
<p>
    <span>| DATE: 3/23 |</span>
    <span>DAY: FRI |</span>
    <span>TIME: 18:30-19:30 |</span>
    <span>Class E</span>
    <span>${classLimitE}/20 |</span>
</p>
</div>
...
<form action="class1proc" method="post" id="class1proc" onsubmit="checkClass()">
    ...
    <p>
        ...
        <span>Date: <input type="text" id="dateField" name="date" class="className" readonly></span>
        <br><span>Day: <input type="text" id="dayField" name="day"  class="className"readonly></span>
        <br><span>Time: <input type="text" id="timeField" name="time" class="className" readonly></span>
